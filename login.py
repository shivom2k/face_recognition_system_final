...
class login:
    def __init__(self, root):
        ...
        # img2 = thapar logo
        img2 = Image.open("Images/thaparLogo.jpeg")
    ...
    def login_details(self):
        if (
            ...
            try: # Now we will connect with SQL
                ...
                # sql = 'select Enroll_no from student where email={}'.format(str(temp_email))
                # print(sql)
                # my_cursor1.execute(sql)
                # roll = my_cursor1.fetchall()
                # self.roll_num = roll[0][0]
                # print("Roll ",roll)
                ...
                if temp_mem == "Student":
                    ...
                    sql="select * from student where email ={}".format(str(temp_email))
                    print(sql)

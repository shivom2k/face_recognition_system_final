...
from adminRegisterStudent import adminStudentRegister
from adminRegisterTeacher import adminTeacherRegister
import cv2
import os
import numpy as np
...
class adminMainPage:
    ...
    def registerStudent(self):
        ...
        self.app = adminStudentRegister(self.new_window)

    def registerTeacher(self):
        self.new_window = Toplevel(self.root) # This asks where we want to open our window
        self.app = adminTeacherRegister(self.new_window)

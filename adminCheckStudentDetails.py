...
class adminCheckStudentDetails:
    ...
    #             my_cursor.execute(
    #                 "insert into student_table values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
    #                 (
    #                     self.var_rollNum.get(),
    #                     self.var_name.get() ,
    #                     self.var_year.get() ,
    ...
    def fetch_data(self, table_name):
        ...
        my_cursor = conn.cursor()
        #my_cursor.execute("select * from {}".format('iii_2ee9'))           # str(table_name)))
        #my_cursor.execute("select Enroll_no, Name, Year, Sem, Dep, Batch, Email, Phone_no, Father_no, Mother_no, Course1, Course2, Course3, Course4, Gender, DOB from student")
